  ...
  if (review.idle) {
    return (
      <section className="flex flex-col gap-2.5">
        ...
        <p className="rounded-card border border-border bg-surface px-4 py-3.5 text-small leading-relaxed text-text-muted">
          Nothing has been scheduled yet this week. Not a miss — there is simply
          nothing to report.
        </p>
      </section>
    )
      ...
      <div className="flex flex-col gap-2.5">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="mt-0.5 flex items-baseline gap-1.5">
              ...
              <span className="text-small tabular-nums text-text-muted">
                of {review.due} scheduled {review.due === 1 ? 'day' : 'days'}
              </span>
            </p>
          </div>
        </div>
        ...
        {review.needsAttention ? (
          <Link
            ...
            className="flex flex-col gap-1 rounded-card border border-border bg-surface px-4 py-3.5 transition-colors duration-fast hover:border-border-interactive/60"
          >
